...
namespace A0Tests.LateTests.Integrate.Implement
{
    ...
    [TestFixture(
        ...
        Author = "agalkin")]
    public class Test_IA0TreeNode : Test_NewAct
    {
        /// <summary>
        /// Получает или устанавливает дерево ЛС.
        /// </summary>
        protected dynamic ActTreeHead { get; set; }
        ...
        public void Test_Count()
        {
            ...
            {
                dynamic treeNode = this.ActTreeHead.Item[i];
        ...
        public void Test_ProgCount()
        {
            ...
            for (int i = 0; i < count; i++)
            {
                dynamic progLine = this.ActTreeHead.Prog.GetItem(i);
