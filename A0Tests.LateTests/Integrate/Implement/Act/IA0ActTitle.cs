...
namespace A0Tests.LateTests.Integrate.Implement
{
    ...
    [TestFixture(
        ...
        Author = "agalkin")]
    public class Test_IA0ActTitle : Test_NewAct
    {
        /// <summary>
        /// Получает или устанавливает заголовок акта.
        /// </summary>
        protected dynamic ActTitle { get; set; }
        ...
        {
            dynamic approval = this.ActTitle.Approval;
        ...
        {
            dynamic audihor = this.ActTitle.Auditor;
        ...
        {
            dynamic author = this.ActTitle.Author;
        ...
        {
            dynamic conform = this.ActTitle.Conform;
        ...
        public void Test_LoadTitleChanges()
        {
            ...
            dynamic act = this.ImplRepo.Act.Load(this.Act.ID.GUID, 0);
