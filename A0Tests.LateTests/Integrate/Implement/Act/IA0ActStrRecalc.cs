...
namespace A0Tests.LateTests.Integrate.Implement
{
    ...
    /// </summary>
    public abstract class Test_ActStrRecalc : Test_IA0ActStrRecalcs
    {
        /// <summary>
        ...
        protected abstract dynamic RecalcKind { get; }
    }
    ...
    public class Test_IA0ActStrRecalcIndex : Test_ActStrRecalc
    {
        /// <summary>
        ...
        /// Получает тип пересчета.
        /// </summary>
        protected override dynamic RecalcKind => 0; // EA0LSStrRecalcKind.lsrIndex
    }
    ...
    public class Test_IA0ActStrRecalcByBasing : Test_ActStrRecalc
    {
        /// <summary>
        /// Проверяет отсутствие ошибок при обращении к признаку "Только базовые итоги".
        /// </summary>
        ...
        /// Получает тип пересчета.
        /// </summary>
        protected override dynamic RecalcKind => 1; // EA0LSStrRecalcKind.lsrByBasing
    }
    ...
    public class Test_IA0ActStrRecalcTo91Prices : Test_ActStrRecalc
    {
        /// <summary>
        /// Проверяет отсутствие ошибок при обращении к индексу для ОЗП.
        /// </summary>
        ...
        /// Получает тип пересчета.
        /// </summary>
        protected override dynamic RecalcKind => 2; // EA0LSStrRecalcKind.lsrTo91Prices
    }
    ...
    public class Test_IA0ActStrRecalcIndexNRSP : Test_ActStrRecalc
    {
        /// <summary>
        /// Проверяет отсутствие ошибок при обращении к признаку "Только базовые итоги".
        /// </summary>
        ...
        /// Получает тип пересчета.
        /// </summary>
        protected override dynamic RecalcKind => 3; // EA0LSStrRecalcKind.lsrIndexNRSP
    }
}