// $Date: 2021-01-11 15:14:31 +0300 (Пн, 11 янв 2021) $
// $Revision: 487 $
// $Author: agalkin $
...
namespace A0Tests.LateTests
{
    ...
    public class EstimateLSConxetCreator : IContextLS
    {
        ...
        public EstimateLSConxetCreator(object a0)
        {
            this.A0 = a0;
            if (this.A0 == null)
            {
        ...
        public virtual void Create()
        {
            ...
            dynamic proj = this.A0.Estimate.Repo.Proj.New2(
            ...
            // Создаем тестовую ОС
            dynamic os = this.A0.Estimate.Repo.OS.New(this.ProjGUID, this.ProjNodeID);
            ...
            // Создаем тестовую ЛС
            dynamic ls = this.A0.Estimate.Repo.LS.New(this.OsGuid, this.OsNodeId);
    ...
    public class EstimateActConxetCreator : EstimateLSConxetCreator, IContextAct
    {
        ...
        /// </summary>
        /// <param name="a0">API A0Service.</param>
        public EstimateActConxetCreator(object a0)
            : base(a0)
        {
        }
        ...
        public override void Create()
        {
            ...
            dynamic act = this.A0.Implement.Repo.Act.New(this.LsGuid, 0, 0, 100);
            Assert.NotNull(act);
            ...
            // Наполнение строками.
            dynamic str = act.CreateTxtString(2, "1", act.Tree.Head.ID); // 2 - EA0StringKind.skMM
            str = act.CreateTxtString(3, "2", act.Tree.Head.ID); // 3 - EA0StringKind.skMK
    ...
    namespace Integrate.Print
    {
        ...
        public class Test_IA0PrintAct : Test_Base
        {
            ...
            {
                // 1 - EA0PrintKind.pkAct.
                dynamic print = this.A0.GetPrint(1, this.TemplatePath);
                ...
                dynamic template = print.Templates.Item[0];
                dynamic setting = print.TemplateSettings.Item[0];
            ...
            public void Test_Signature()
            {
                ...
                dynamic print = this.A0.GetPrint(1, this.TemplatePath); // 1 - EA0PrintKind.pkAct.
                ...
                {
                    dynamic template = print.Templates.Item[ti];
                    ...
                    {
                        dynamic item = setting.Propertys.Item[j];
                        switch (item.Name)
                        {
                            case @"chbPrintSmet":
                                item.Value = true;
