...
namespace A0Tests.LateTests.Integrate.Estimate
{
    ...
    public class Test_IA0OSIDRepo : Test_NewOS
    {
        ...
        public void Test_Read()
        {
            ...
            this.ReadEstimateObject(iterator, 3);
        }
        ...
        {
            dynamic appFieldsReq = this.Repo.OSID.GetFiledsRequest();
            appFieldsReq.Add("[OSTitle].[UpdateMoment]");
            dynamic iterator = this.Repo.OSID.Read(this.Proj.ID.GUID, appFieldsReq, null, null);
        ...
        {
            dynamic where = this.Repo.OSID.GetWhereRequest();
            where.Node.And3("[OSTitle].[TotalNodeID]", "=", this.Repo.ProjID.HeadNodeID.ToString());
            dynamic iterator = this.Repo.OSID.Read(this.Proj.ID.GUID, null, where, null);
        ...
        {
            dynamic secondOS = this.CreateOS("Вторая ОС " + DateTime.Now.ToString());

            // Сортировка по дате создания
            dynamic order = this.Repo.OSID.GetOrderRequest();
            order.Add("[OSTitle].[CreateMoment]");
            dynamic iterator = this.Repo.OSID.Read(this.Proj.ID.GUID, null, null, order);
    ...
    public class Test_IAppOSFieldsRequest : Test_Estimate
    {
        ...
        /// </summary>
        protected dynamic AppLSFieldsRequest { get; set; }
        ...
        public void Test_Parent()
        {
            string field = "field";
            this.AppLSFieldsRequest.Add(field);
            dynamic parent = this.AppLSFieldsRequest.Parent;
        ...
        public void Test_Totals()
        {
            string field = "field";
            this.AppLSFieldsRequest.Add(field);
            dynamic totals = this.AppLSFieldsRequest.Totals;
    ...
    public class Test_ISQLWhere : Test_Estimate
    {
        ...
        /// </summary>
        protected dynamic Where { get; set; }

        /// <summary>
        /// Получает или устанавливает узел фильтрующего запроса.
        /// </summary>
        protected dynamic WhereNode { get; set; }
    ...
    public class Test_ISQLOrder : Test_Estimate
    {
        ...
        /// </summary>
        protected dynamic Order { get; set; }
