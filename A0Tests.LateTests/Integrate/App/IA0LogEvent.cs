...
namespace A0Tests.LateTests.Integrate
{
    ...
    public class A0LogEvent
    {
        ...
        public struct Message
        {
            ...
            public Message(dynamic type, string text)
            {
            ...
            /// </summary>
            public dynamic MessageType { get; }
        ...
        public void OnLog(dynamic aType, string aStr)
        {
    ...
    public class Test_IA0LogEvent : Test_Base
    {
        ...
        public void Test_Log()
        {
            ...
            Assert.True(logEvent.Messages.Contains(new A0LogEvent.Message(0, error))); // EAppLogMessageType.lmtError
            Assert.True(logEvent.Messages.Contains(new A0LogEvent.Message(4, exceptLog))); // EAppLogMessageType.lmtExceptLog
            Assert.True(logEvent.Messages.Contains(new A0LogEvent.Message(2, message))); // EAppLogMessageType.lmtMessage
            Assert.True(logEvent.Messages.Contains(new A0LogEvent.Message(3, trace))); // EAppLogMessageType.lmtTrace
            Assert.True(logEvent.Messages.Contains(new A0LogEvent.Message(1, warning))); // EAppLogMessageType.lmtWarning
        }
