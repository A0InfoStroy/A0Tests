...
namespace A0Tests.LateTests.Smoke
{
    ...
    public class Test_IA0App : Test_Base
    {
        ...
        /// </summary>
        protected dynamic App { get; private set; }
        ...
        {
            dynamic version = this.App.Version;
        ...
        {
            dynamic connection = this.App.Connection;
        ...
        {
            dynamic attributes = this.App.Attributes;
        ...
        {
            dynamic attrExtension = this.App.AttrExtension;
