...
namespace A0Tests.Integrate.Implement.Services
{
    using A0Service;
    ...
    /// <summary>
    /// Содержит базовые тесты проверки работоспособности сервисов акта.
    /// </summary>
    [TestFixture(
        Category = "Integrate",
        Description = "Базовые тесты проверки работоспособности IA0ImplementServices",
        Author = "agalkin")]
    public abstract class Test_IA0ImplementServicesBase : NewLSStringBase
    {
        /// <summary>
        /// Получает или устанавливает сервис акта.
        /// </summary>
        protected IA0ImplementServices Services { get; set; }
        ...
        /// </summary>
        [Test(Description = "Создание акта"), Timeout(20000)]
        public virtual void Test_FromLS()
        {
        ...
        public virtual void Test_FromLS_TN()
        {
        ...
        protected IA0Act CreateActFromLS(double heelsPercent)
        {
        ...
        protected void DeleteAct(Guid actGuid)
        {
        ...
        /// </summary>
        protected IA0TreeNode GetLastNode(IA0TreeNode node)
        {
