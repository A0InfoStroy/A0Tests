...
// $Revision: 590 $
// $Author: eloginov $
// Тесты IA0ImplementServices для строк (типа работа) ЛС
...
namespace A0Tests.Integrate.Implement.Services.ImplementServices
{
    ...
    /// <summary>
    ///  Содержит тесты проверки работоспособности сервисов актов для строк (типа работа).
    /// </summary>
    [TestFixture(
        Category = "Integrate",
        Description = "Тесты проверки работоспособности IA0ImplementServices для строк (типа работа)",
        Author = "agalkin")]
    class WorkLSString_IA0ImplementServices : Test_IA0ImplementServicesBase
    {
        /// <summary>
        ...
        public void Test_CreateWorkStr()
        {
            ...
            // Создание строк (типа работа).
            for (var i = 1; i <= stringCount; i++)
            {
                IA0ActString actString = act.CreateWorkString(aNSIID: 7, aFolderID: 2553, aWorkID: 787669, aNodeID: node.ID);
