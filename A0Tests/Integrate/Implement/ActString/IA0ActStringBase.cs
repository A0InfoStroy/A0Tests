...
// $Revision: 592 $
// $Author: eloginov $
// Тесты строки Акта IA0ActString

namespace A0Tests.Integrate.Implement.ActString
{
    using System;
    ...
    /// <summary>
    /// Базовый класс для создания абстрактной тестируемой строки акта.
    /// </summary>
    [TestFixture(
        Category = "Integrate",
        Description = "Тесты проверки работоспособности IA0ActString",
        Author = "vbutov")]
    public abstract class Test_IA0ActStringBase : NewActStringBase
    {
        /// <summary>
        ...
        /// </summary>
        [Test, Timeout(20000)]
        public virtual void Test_ActNumber()
        {
        ...
        /// </summary>
        [Test, Timeout(20000)]
        public virtual void Test_ActVolume_Nat()
        {
        ...
        /// </summary>
        [Test, Timeout(20000)]
        public virtual void Test_Remainder()
        {
        ...
        /// </summary>
        [Test, Timeout(20000)]
        public virtual void Test_PriceSource_psNSI()
        {
        ...
        /// </summary>
        [Test, Timeout(20000)]
        public virtual void Test_PriceSource_psPriceRef()
        {
        ...
        /// </summary>
        [Test, Timeout(20000)]
        public virtual void Test_ExpenseKindd()
        {
        ...
        /// </summary>
        [Test, Timeout(20000)]
        public virtual void Test_ParentAdjustedVolume()
        {
        ...
        /// </summary>
        [Test, Timeout(20000)]
        public virtual void Test_ParentExecutions()
        {
        ...
        /// </summary>
        [Test, Timeout(20000)]
        public virtual void Test_ParentStrID()
        {
        ...
        /// </summary>
        [Test, Timeout(20000)]
        public virtual void Test_ParentStrGUID()
        {
