...
// $Revision: 593 $
// $Author: eloginov $
// Тесты расценки текстовой строки акта.
...
namespace A0Tests.Integrate.Implement.ActString.ActStrBasing
{
    ...
    /// <summary>
    /// Содержит тесты проверки работоспособности расценки текстовой строки акта.
    /// </summary>
    [TestFixture(
        Category = "Integrate",
        Description = "Тесты проверки работоспособности IA0LSStrBasing текстовой строки акта",
        Author = "agalkin")]
    class Test_TxtActString_IA0ActStrBasing : Test_IA0ActStrBasingBase
    {
        /// <summary>
