...
// $Revision: 593 $
// $Author: eloginov $
// Абстрактный класс тестов расценки строки акта
...
namespace A0Tests.Integrate.Implement.ActString.ActStrBasing
{
    ...
    /// <summary>
    /// Абстрактная тестовая группа (класс) проверки работоспособности расценки строки акта.
    /// </summary>
    [TestFixture(
        Category = "Integrate",
        Description = "Тесты проверки работоспособности IA0LSStrBasing",
        Author = "agalkin")]
    public abstract class Test_IA0ActStrBasingBase : NewActStringBase
    {
        /// <summary>
