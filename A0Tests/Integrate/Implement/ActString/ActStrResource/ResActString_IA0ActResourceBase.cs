...
// $Revision: 595 $
// $Author: eloginov $
// Тесты ресурса строки (типа ресурс) акта
...
namespace A0Tests.Integrate.Implement.ActString.ActStrResource
{
    ...
    /// <summary>
    /// Содержит тесты проверки работоспособности ресурса строки (типа ресурс) акта.
    /// </summary>
    [TestFixture(
        Category = "Integrate",
        Description = "Тесты проверки работоспособности IA0Resource строки (типа ресурс) акта",
        Author = "agalkin")]
    class Test_ResActString_IA0ActResourceBase : Test_IA0ActResourceBase
    {
        /// <summary>
