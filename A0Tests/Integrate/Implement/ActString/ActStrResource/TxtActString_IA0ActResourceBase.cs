...
// $Revision: 595 $
// $Author: eloginov $
// Тесты ресурса текстовой строки акта
...
namespace A0Tests.Integrate.Implement.ActString.ActStrResource
{
    ...
    /// <summary>
    /// Содержит тесты проверки работоспособности ресурса текстовой строки акта.
    /// </summary>
    [TestFixture(
        Category = "Integrate",
        Description = "Тесты проверки работоспособности IA0Resource для текствой строки ресурса",
        Author = "agalkin")]
    class Test_TxtActString_IA0ActResourceBase : Test_IA0ActResourceBase
    {
        /// <summary>
