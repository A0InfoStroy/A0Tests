...
// $Revision: 595 $
// $Author: eloginov $
// Абстрактный класс тестов ресурса строки акта
...
namespace A0Tests.Integrate.Implement.ActString.ActStrResource
{
    ...
    /// <summary>
    /// Абстрактная тестовая группа (класс) проверки работоспособности ресурса строки акта.
    /// </summary>
    [TestFixture(
        Category = "Integrate",
        Description = "Тесты проверки работоспособности IA0Resource",
        Author = "agalkin")]
    public abstract class Test_IA0ActResourceBase : NewActStringBase
    {
        /// <summary>
        ...
        private decimal SumResourceCosts()
        {
            ...
            {
                IA0Resource resource = this.ActString.Resources.Items[i];
