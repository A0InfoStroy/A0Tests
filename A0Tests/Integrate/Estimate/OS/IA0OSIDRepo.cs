...
namespace A0Tests.Integrate.Estimate
{
    ...
    [TestFixture(
        ...
        Author = "agalkin")]
    public class Test_IA0OSIDRepo : NewOS
    {
        /// <summary>
    ...
    [TestFixture(
        ...
        Author = "agalkin")]
    public class Test_IAppOSFieldsRequest : Test_EstimateCustom
    {
        /// <summary>
    ...
    [TestFixture(
        ...
        Author = "agalkin")]
    public class Test_ISQLWhere : Test_EstimateCustom
    {
        /// <summary>
    ...
    [TestFixture(
        ...
        Author = "agalkin")]
    public class Test_ISQLOrder : Test_EstimateCustom
    {
        /// <summary>
