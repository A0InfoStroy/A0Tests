...
// $Revision: 373 $
// $Author: agalkin $
// Базовые тесты IA0LSExecutionLinkRepoID
...
namespace A0Tests.Smoke.Links
{
    ...
    /// <summary>
    /// Содержит базовые тесты проверки работоспособности каталога связей ЛС по исполнению.
    /// </summary>
    [TestFixture(
        Category = "smoke",
        Description = "Базовые тесты проверки работоспособности IA0LSExecutionLinkRepoID",
        Author = "agalkin")]
    public class Test_IA0LSExecutionLinkRepoID : Test_Base
    {
        /// <summary>
        /// Получает или устанавливает каталог связей ЛС по исполнению.
        /// </summary>
        protected IA0LSExecutionLinkRepoID Repo { get; private set; }
        ...
        {
            base.SetUp();
            this.Repo = this.A0.Links.LS.Repos.ExecutionID;
