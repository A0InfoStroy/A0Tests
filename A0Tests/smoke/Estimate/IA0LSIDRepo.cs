...
namespace A0Tests.Smoke.Estimate
{
    ...
    /// <summary>
    ///  Содержит базовые тесты проверки работоспособности каталога поиска ЛС.
    /// </summary>
    [TestFixture(
        Category = "smoke",
        Description = "Базовые тесты проверки работоспособности IA0LSIDRepo",
        Author = "agalkin")]
    public class Test_IA0LSIDRepo : Test_Base
    {
        /// <summary>
        /// Получает или устанавливает каталог поиска ЛС.
        /// </summary>
        protected IA0LSIDRepo Repo { get; private set; }
        ...
        {
            base.SetUp();
            this.Repo = this.A0.Estimate.Repo.LSID;
