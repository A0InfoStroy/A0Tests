// $Date: 2021-01-27 15:20:26 +0300 (Ср, 27 янв 2021) $
// $Revision: 512 $
// $Author: agalkin $
// Тесты расчета параметров ресурса строки акта.

namespace A0Tests.EarlyTests.Functional.Calculations.Resources
{
    using A0Service;
    ...
    [TestFixture(
        ...
        Author = "agalkin")]
    public class Test_LSStrResource : Test_NewLSString
    {
